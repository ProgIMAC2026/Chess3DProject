...
public:
    Scene()
        : camera(CameraParameters{.position = glm::vec3(0.f, 0.5f, 0.5f), .target = glm::vec3(0.f, 0.f, 0.f), .up = glm::vec3(0.f, 1.f, 0.f), .fov = 45.f, .aspect = 800.f / 600.f, .near = 0.1f, .far = 100.f}) {};
